/*
** ins_xor.c for corewar in /home/barrau_a//c/corewar/corewar_2013s/trunk/vm
** 
** Made by adrien barrau
** Login   <barrau_a@epitech.net>
** 
** Started on  Sat Dec 11 03:22:25 2010 adrien barrau
** Last update Sat Dec 18 22:04:43 2010 adrien barrau
*/
	       ...
	       unsigned char *tab_oct)
{
  ...
  if (reg >= 1 && reg <= REG_NUMBER)
	...
	my_printf(V_INS_XOR_MSG, champ->number, op_left, op_right, reg);
		...
		t_lives *lives)
{
  ...
  if (tab_oct)
    do_xor(champ, big_male, param_vm, tab_oct);
  else
    champ->pc = (champ->pc + 1) % MEM_SIZE;
  free(tab_oct);
}
