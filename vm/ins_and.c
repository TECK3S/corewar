/*
** ins_and.c for corewar in /home/barrau_a//c/corewar/corewar_2013s/trunk/vm
** 
** Made by adrien barrau
** Login   <barrau_a@epitech.net>
** 
** Started on  Sat Dec 11 03:20:33 2010 adrien barrau
** Last update Sat Dec 18 17:18:14 2010 adrien barrau
*/
...
static void	do_and(t_champion *champ,
		       ...
		       unsigned char *tab_oct)
{
  ...
  reg = (*big_male)[TO_ABS((champ->pc + 2 + op_left_size + op_right_size)
			   % MEM_SIZE)];
  if (reg >= 1 && reg <= REG_NUMBER)
	...
	my_printf(V_INS_AND_MSG, champ->number, op_left, op_right, reg);
		...
		t_lives *lives)
{
  ...
  if (tab_oct)
    do_and(champ, big_male, param_vm, tab_oct);
  else
    champ->pc = (champ->pc + 1) % MEM_SIZE;
  free(tab_oct);
}
