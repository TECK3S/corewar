/*
** ins_gtmd.c for corewar in /home/barrau_a//c/corewar/corewar_2013s/trunk/vm
** 
** Made by adrien barrau
** Login   <barrau_a@epitech.net>
** 
** Started on  Sat Dec 11 03:29:40 2010 adrien barrau
** Last update Sat Dec 18 17:04:22 2010 adrien barrau
*/
			 ...
			 t_lives *lives)
{
  ...
  if (tab_oct)
	...
	{
	  champ->registers[(*big_male)[TO_ABS((champ->pc + 2)
					      % MEM_SIZE)] - 1] = CTMO_TO_REAL_VAL;
	  if (param_vm->is_verbose)
	    my_printf(V_INS_GTMD_MSG, CTMO_TO_REAL_VAL);
