/*
** do_ldi.c for my_asm in /home/ngonta_e//my_home/rendu/c/corewar/corewar_2013s/trunk
** 
** Made by eugene-valentin ngontang-tchiadjie
** Login   <ngonta_e@epitech.net>
** 
** Started on  Thu Dec 16 19:26:57 2010 eugene-valentin ngontang-tchiadjie
** Last update Sun Dec 19 15:02:42 2010 eugene-valentin ngontang-tchiadjie
*/
...
static void	getldi_octet_code(char **params,
...
void	do_ldi(unsigned char **str, int *i,
	       char **params, t_param **call_list)
{
  ...
  cpt = 0;
  octet_code = 0;
  getldi_octet_code(params, &octet_code);
